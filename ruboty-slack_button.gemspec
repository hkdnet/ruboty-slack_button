...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Create button from your ruboty.'
  spec.description   = 'An extension for ruboty to create a button in your channel.'
  spec.homepage      = "https://github.com/hkdnet/ruboty-slack-button"
  spec.license       = "MIT"
